...
export const HELP = {
  subtitle: { y: 120 },
  /** 分组标题是左对齐、按左上角摆的，不像标题与副标题那样居中——它向下长 36px。 */
  groupTitle: { y: 156 },
  columnX: [44, 492],
  /**
   * 六行 44 高的胶囊要塞进分组标题底（156 + 36 = 192）到页脚盒顶（494 − 28/2 = 480）
   * 之间。两头都容易算错：footer.y 是中线不是上沿，按 494 算会凭空多出 14px，第六行
   * 就压到页脚上；分组标题按左上角摆，当成居中算又会少留 18px，第一行反过来压到它。
   * 5×48 + 44 = 284，正好落在 194–478。
   */
  firstRowY: 194,
  rowGap: 48,
